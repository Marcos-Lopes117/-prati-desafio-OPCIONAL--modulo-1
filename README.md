...
# Se tudo for configurado corretamente, vocês já conseguem rodar o arquivo principal, nomeado como (00-TodosCompilados01-49.js),
após abrir o programa, digite o atalho Ctrl+alt+j para rodar o código, selecione javascript.

OBS: Os exercícios foram feitos exportando o módulo para se compilar apelas em um arquivo Js.


# Exercício 50 - Projeto de Hotel via console.

Para rodar o programa, abra o navegador => opções de desenvolvedor => console.
Certifique-se de habilitar a opção de colar codigos fontes no console.
Copie o Codigo fonte do arquivo (50-ProjetoHotel.js) e cole no console do navegador.
